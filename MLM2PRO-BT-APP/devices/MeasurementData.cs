...
namespace MLM2PRO_BT_APP
{
    class MeasurementData
    {
        ...
        public double VLaunch { get; set; }
        public double HLaunch { get; set; }
        ...
        public OpenConnectApiMessage ConvertHexToMeasurementData(string hexData)
        {
            ...
            HLaunch = BitConverter.ToInt16(bytes, 4) / 10.0;
            VLaunch = BitConverter.ToInt16(bytes, 6) / 10.0;
            SpinAxis = BitConverter.ToInt16(bytes, 8);
            TotalSpin = BitConverter.ToUInt16(bytes, 10);
            Unknown1 = BitConverter.ToUInt16(bytes, 12);
            Unknown2 = BitConverter.ToUInt16(bytes, 14);
